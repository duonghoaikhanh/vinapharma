  ...
  return this.each(function () {
    ...
    if (C.color_box) {
      /*jQuery(aitem).wrap('<span style="margin:0;padding:0 ' + jQuery(aitem).outerHeight() + 'px 0 0;display:inline-block;border:none;background:none;line-height:auto;"></span>')*/
			jQuery(aitem).wrap('<div class="excolor_clrbox-wrapper" style="margin:0;padding:0 ' + jQuery(aitem).outerHeight() + 'px 0 0;border:none;background:none;line-height:auto;"></div>')
    }
    var u = '',
      rad3px = '',
      radwrap = '',

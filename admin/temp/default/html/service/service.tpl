  ...
  <div class="row">
    ...
    <div class="col-lg-6">
      <div class="form-group">
        <label>{LANG.service.service_group}</label>
        {data.list_group}
      </div>
    </div>
    <div class="col-lg-6">
  ...
  <div class="row">
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <p class="help-block">{LANG.service.friendly_link_note}</p>
      </div>
    </div>
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <table class="table table-bordered table-hover table-striped table_row">
          ...
          <tbody>
            ...
            <tr id="row_{row.item_id}">
              ...
              <td class="cot">
              	<div><strong>{LANG.service.service_group}:</strong> {row.group_name}</div>

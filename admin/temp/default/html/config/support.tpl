...
<form action="{data.link_action}" method="post" enctype="multipart/form-data" name="myForm" id="myForm" role="form">
  <div class="row">
    ...
    <div class="col-lg-6">
      <div class="form-group">
        <label>Yahoo</label>
        <input name="yahoo" id="yahoo" type="text" size="50" maxlength="150" value="{data.yahoo}" class="form-control">
      </div>
    </div>
    <div class="col-lg-6">
      <div class="form-group">
        <label>Skype</label>
        <input name="skype" id="skype" type="text" size="50" maxlength="150" value="{data.skype}" class="form-control">
      </div>
    </div>
    <div class="col-lg-6">
      <div class="form-group">
        <label>{LANG.config.phone}</label>
        ...
        <table class="table table-bordered table-hover table-striped table_row">
          ...
          <tbody>
            ...
            <tr id="row_{row.item_id}">
              ...
              <td class="cot">{row.pre_title}<input type="text" value="{row.show_order}" name="show_order[{row.item_id}]" size="4" style="text-align:center;" onchange="do_check ({row.item_id})"></td>

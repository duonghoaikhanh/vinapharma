...
<form action="{data.link_action}" method="post" enctype="multipart/form-data" name="myForm" id="myForm" role="form">
  <div class="row">
    ...
    <div class="col-lg-6">
      <div class="form-group">
        <label>{LANG.config.icon_menu}</label>
        <input name="icon_menu" id="icon_menu" type="text" size="50" maxlength="150" value="{data.icon_menu}" class="form-control">
      </div>
    </div>
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <table class="table table-bordered table-hover table-striped table_row">
          <thead>
            <tr >
              ...
              <th class="header" width="5%">{data.f_menu_id}</th>
          ...
          <tbody>
            ...
            <tr id="row_{row.menu_id}">
              ...
              <td class="cot" align="center">{row.menu_id}</td>

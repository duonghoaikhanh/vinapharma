  ...
  <div class="row">
    ...
    <!--<div class="col-lg-6">
      <div class="form-group">
        <label>{LANG.video.video_group}</label>
        {data.list_group}
      </div>
    </div>-->
    <div class="col-lg-6">
    ...
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <input name="video" id="video" type="text" size="50" maxlength="150" value="{data.video}" class="form-control">
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="form-group">
        ...
        <p class="help-block">{LANG.global.meta_desc}</p>
      </div>
    </div>
  </div>
    ...
    <div class="box_search">
      <form action="{data.link_action}" method="post" name="form_search" id="form_search">
        <div class="row_search">
          <!--<div class="col_search"><label>{LANG.video.video_group}:</label> {data.list_group_search}</div>-->

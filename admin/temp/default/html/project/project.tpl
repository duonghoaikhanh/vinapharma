  ...
  <div class="row">
    ...
    <div class="col-lg-6">
      <div class="form-group">
        <label>{LANG.project.project_group}</label>
        {data.list_group}
      </div>
    </div>
    <div class="col-lg-6">
  ...
  <div class="row">
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <p class="help-block">{LANG.project.friendly_link_note}</p>
      </div>
    </div>
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <table class="table table-bordered table-hover table-striped table_row">
          ...
          <tbody>
            ...
            <tr id="row_{row.item_id}">
              ...
              <td class="cot">
              	<div><strong>{LANG.project.project_group}:</strong> {row.group_name}</div>

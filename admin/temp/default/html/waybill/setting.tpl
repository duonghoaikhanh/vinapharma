...
<form action="{data.link_action}" method="post" enctype="multipart/form-data" name="myForm" id="myForm" role="form">
  ...
  <div class="row">
    <div class="col-lg-6">
    	<h2>{LANG.waybill.setting_waybill}</h2>
      <div class="form-group">
        <label>{LANG.global.meta_title}</label>
        <input name="waybill_meta_title" id="waybill_meta_title" type="text" size="50" maxlength="150" value="{data.waybill_meta_title}" class="form-control">
        <p class="help-block">{LANG.global.meta_title_note}</p>
      </div>
      <div class="form-group">
        <label>{LANG.global.meta_key}</label>
        <textarea name="waybill_meta_key" id="waybill_meta_key" class="form-control" rows="1">{data.waybill_meta_key}</textarea>
        <p class="help-block">{LANG.global.meta_key_note}</p>
      </div>
      <div class="form-group">
        <label>{LANG.global.meta_desc}</label>
        <textarea name="waybill_meta_desc" id="waybill_meta_desc" class="form-control" rows="1">{data.waybill_meta_desc}</textarea>
        <p class="help-block">{LANG.global.meta_desc_note}</p>
      </div>
    </div>
    <div class="col-lg-6">
    	<h2>{LANG.waybill.setting_signup}</h2>
      <div class="form-group">
    ...
    <div class="col-lg-6">
    	<h2>{LANG.waybill.setting_signin}</h2>
      <div class="form-group">
        <label>{LANG.global.friendly_link}</label>
    ...
    <div class="col-lg-6">
    	<h2>{LANG.waybill.setting_change_pass}</h2>
      <div class="form-group">
        <label>{LANG.global.friendly_link}</label>
    ...
    <div class="col-lg-6">
    	<h2>{LANG.waybill.setting_forget_pass}</h2>
      <div class="form-group">
        <label>{LANG.global.friendly_link}</label>
    ...
    <div class="col-lg-6">
    	<h2>{LANG.waybill.setting_ordering}</h2>
      <div class="form-group">
        <label>{LANG.global.friendly_link}</label>
    ...
    <div class="col-lg-6">
    	<h2>{LANG.waybill.setting_promotion}</h2>
      <div class="form-group">
        <label>{LANG.global.friendly_link}</label>
    ...
    <div class="col-lg-6">
    	<h2>{LANG.waybill.setting_voucher}</h2>
      <div class="form-group">
        <label>{LANG.global.friendly_link}</label>

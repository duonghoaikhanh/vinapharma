    ...
    <div class="box_search">
      <form action="{data.link_action_search}" method="post" name="form_search" id="form_search">
        <div class="row_search">
          <div class="col_search"><label>{LANG.repository.product}:</label> {data.list_product_search}</div>
      ...
      <table class="table table-bordered table-hover table-striped table_row">
        <thead>
          <tr >
            ...
            <th class="header" width="10%">{data.f_quantity}</th>
        ...
        <tbody>
          ...
          <tr id="row_{row.item_id}">
            ...
            <td class="cot" align="center"><a href="{row.link_receipt_detail}" class="fancybox fancybox.ajax" >{LANG.global.view}</a></td>
          </tr>
          <!-- END: row_item --> 
          <!-- BEGIN: row_empty -->
          <tr class="warning">

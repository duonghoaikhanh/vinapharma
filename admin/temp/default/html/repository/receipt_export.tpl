...
<form action="{data.link_action}" method="post" enctype="multipart/form-data" name="myForm" id="myForm" role="form">
    ...
    <div class="col-lg-12">
      <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped table_row">
          <thead>
            <tr >
              <th class="header">Tên sản phẩm</th>
              <th class="header" width="15%">Màu</th>
              <th class="header" width="10%">Size</th>
              <th class="header" width="15%">Giá bán</th>
              <th class="header" width="10%">Số lượng</th>
              <th class="header" width="10%">Đã xuất</th>
              <th class="header" width="10%">Xuất kho</th>
            </tr>
          </thead>
          <tbody id="tbody_ordering">
          	<tr class="warning">
              <td align="center" colspan="7">{LANG.global.no_have_data}</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <script language="javascript">ttHReceipt.add_order_row();</script>
  <div class="row">
    <div class="col-lg-6">
      <div class="form-group">
...
<form action="{data.link_action}" method="post" enctype="multipart/form-data" name="myForm" id="myForm" role="form">
  ...
  <div class="row">
    <div class="col-lg-12">
        ...
        <table class="table table-bordered table-hover table-striped table_row">
          <thead>
            <tr >
              ...
              <th class="header" width="15%">Giá nhập</th>
      ...
      <div id="list_sub">
      	<!-- BEGIN: row_sub -->
      	<div id="sub_{data.list_id}" class="popup_limit" style="min-width:700px; display:none;">
          <div class="table-responsive">
            <table class="table table-bordered table-hover table-striped table_row">
              <thead>
                <tr >

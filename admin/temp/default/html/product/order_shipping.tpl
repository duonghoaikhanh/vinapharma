        ...
        <table class="table table-bordered table-hover table-striped table_row">
          <thead>
            <tr >
              ...
              <th class="header" width="5%">{data.f_shipping_id}</th>
          ...
          <tbody>
          	<!-- BEGIN: row_item -->
            <tr id="row_{row.shipping_id}">
              <td class="cot" align="center"><input class="checkbox" type="checkbox" value="{row.shipping_id}" name="selected_id[]"></td>
              <td class="cot" align="center">{row.shipping_id}</td>
              <td class="cot" align="center"><input type="text" value="{row.show_order}" name="show_order[{row.shipping_id}]" size="4" style="text-align:center;" onchange="do_check ({row.shipping_id})"></td>

        ...
        <table class="table table-bordered table-hover table-striped table_row">
          <thead>
            <tr >
              ...
              <th class="header" width="5%">{data.f_method_id}</th>
          ...
          <tbody>
          	<!-- BEGIN: row_item -->
            <tr id="row_{row.method_id}">
              <td class="cot" align="center"><input class="checkbox" type="checkbox" value="{row.method_id}" name="selected_id[]"></td>
              <td class="cot" align="center">{row.method_id}</td>
              <td class="cot" align="center"><input type="text" value="{row.show_order}" name="show_order[{row.method_id}]" size="4" style="text-align:center;" onchange="do_check ({row.method_id})"></td>
              <td class="cot" align="center">{row.picture}</td>
              <td class="cot">{row.title}</td>
              <td class="cot" align="center"><a href="{row.link_setting}">{row.name_action}</a></td>

        ...
        <table class="table table-bordered table-hover table-striped table_row">
          <thead>
            <tr >
              ...
              <th class="header" width="5%">{data.f_code_pic_id}</th>
          ...
          <tbody>
          	<!-- BEGIN: row_item -->
            <tr id="row_{row.code_pic_id}">
              <td class="cot" align="center"><input class="checkbox" type="checkbox" value="{row.code_pic_id}" name="selected_id[]"></td>
              <td class="cot" align="center">{row.code_pic_id}</td>
              <td class="cot" align="center"><input type="text" value="{row.show_order}" name="show_order[{row.code_pic_id}]" size="4" style="text-align:center;" onchange="do_check ({row.code_pic_id})"></td>

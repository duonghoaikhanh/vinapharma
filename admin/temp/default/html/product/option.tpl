        ...
        <table class="table table-bordered table-hover table-striped table_row">
          <thead>
            <tr >
              ...
              <th class="header" width="5%">{data.f_option_id}</th>
          ...
          <tbody>
            ...
            <tr id="row_{row.option_id}">
              <td class="cot" align="center"><input class="checkbox" type="checkbox" value="{row.option_id}" name="selected_id[]"></td>
              <td class="cot" align="center">{row.option_id}</td>
              <td class="cot" align="center">{row.pre_title}<input type="text" value="{row.show_order}" name="show_order[{row.option_id}]" size="4" style="text-align:center;" onchange="do_check ({row.option_id})"></td>

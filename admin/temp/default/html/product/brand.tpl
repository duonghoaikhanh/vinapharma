  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="form-group">
        ...
        <textarea name="meta_title" id="meta_title" class="form-control" rows="3">{data.meta_title}</textarea>
        ...
        <table class="table table-bordered table-hover table-striped table_row">
          <thead>
            <tr >
              ...
              <th class="header" width="5%">{data.f_brand_id}</th>
          ...
          <tbody>
          	<!-- BEGIN: row_item -->
            <tr id="row_{row.brand_id}">
              <td class="cot" align="center"><input class="checkbox" type="checkbox" value="{row.brand_id}" name="selected_id[]"></td>
              <td class="cot" align="center">{row.brand_id}</td>
              <td class="cot" align="center">{row.pre_title}<input type="text" value="{row.show_order}" name="show_order[{row.brand_id}]" size="4" style="text-align:center;" onchange="do_check ({row.brand_id})"></td>

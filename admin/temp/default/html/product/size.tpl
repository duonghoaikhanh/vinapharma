        ...
        <table class="table table-bordered table-hover table-striped table_row">
          <thead>
            <tr >
              ...
              <th class="header" width="5%">{data.f_size_id}</th>
          ...
          <tbody>
          	<!-- BEGIN: row_item -->
            <tr id="row_{row.size_id}">
              <td class="cot" align="center"><input class="checkbox" type="checkbox" value="{row.size_id}" name="selected_id[]"></td>
              <td class="cot" align="center">{row.size_id}</td>
              <td class="cot" align="center">{row.pre_title}<input type="text" value="{row.show_order}" name="show_order[{row.size_id}]" size="4" style="text-align:center;" onchange="do_check ({row.size_id})"></td>

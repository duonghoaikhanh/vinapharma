...
<div class="table-responsive">
  <table class="table table-bordered table-hover table-striped table_row">
    <thead>
      <tr >
        <th class="header" width="10%">{LANG.product.col_picture}</th>
        <th class="header">{LANG.product.col_title}</th>
        <th class="header" width="10%">{LANG.product.col_color}</th>
        <th class="header" width="10%">{LANG.product.col_code_pic}</th>
        <th class="header" width="15%">{LANG.product.col_price}</th>
        <th class="header" width="10%">{LANG.product.col_quantity}</th>
        <th class="header" width="15%">{LANG.product.col_total}</th>
      </tr>
    </thead>
    <tbody>
      <!-- BEGIN: row_item -->
      <tr>
        ...
        <td class="cot" align="center">{row.color}</td>
        <td class="cot" align="center">{row.code_pic}</td>
      ...
      <!-- END: row_empty --> 
      <tr>
        <td class="cot" align="right" colspan="6">
          {LANG.product.cart_total}
        </td>
        <td class="cot" align="right">
          {data.cart_total}
        </td>
      </tr>
    </tbody>
...
<form action="{data.link_action}" method="post" enctype="multipart/form-data" name="myForm" id="myForm" role="form">
  ...
  <div class="row">
    <div class="col-lg-12">
    	<h2>{LANG.product.ordering_cart}</h2>
      <div class="form-group">
        {data.table_cart}
      </div>
      <div class="form-group">
      	<label>{LANG.product.ordering_shipping}: {data.shipping.title}</label>
        <div class="form-control-static">{data.shipping.content}</div>
      </div>
      <div class="form-group">
      	<label>{LANG.product.ordering_method}: {data.method.title}</label>
        <div class="form-control-static">{data.method.content}</div>
      </div>
      <div class="form-group">
      	<label>{LANG.product.request_more}</label>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="form-group">
        <label>{LANG.product.status_order}</label>

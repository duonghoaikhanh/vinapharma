        ...
        <table class="table table-bordered table-hover table-striped table_row">
          <thead>
            <tr >
              ...
              <th class="header" width="5%">{data.f_status_id}</th>
          ...
          <tbody>
          	<!-- BEGIN: row_item -->
            <tr id="row_{row.status_id}">
              <td class="cot" align="center"><input class="checkbox" type="checkbox" value="{row.status_id}" name="selected_id[]"></td>
              <td class="cot" align="center">{row.status_id}</td>
              <td class="cot" align="center">{row.pre_title}<input type="text" value="{row.show_order}" name="show_order[{row.status_id}]" size="4" style="text-align:center;" onchange="do_check ({row.status_id})"></td>

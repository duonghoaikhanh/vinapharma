...
<form action="{data.link_action}" method="post" enctype="multipart/form-data" name="myForm" id="myForm" role="form">
  ...
  <div class="row">
    <div class="col-lg-6">
    	<h3>{LANG.page.setting_page}</h3>
      <div class="form-group">
        <label>{LANG.global.meta_title}</label>
        <input name="page_meta_title" id="page_meta_title" type="text" size="50" maxlength="150" value="{data.page_meta_title}" class="form-control">
  ...
  <div class="row">
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <textarea name="page_meta_key" id="page_meta_key" class="form-control" rows="1">{data.page_meta_key}</textarea>
    ...
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <textarea name="page_meta_desc" id="page_meta_desc" class="form-control" rows="1">{data.page_meta_desc}</textarea>

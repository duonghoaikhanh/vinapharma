  ...
  <div class="row">
    ...
    <div class="col-lg-6">
      <div class="form-group">
        <label>{LANG.download.download_group}</label>
        {data.list_group}
      </div>
    </div>
    <div class="col-lg-6">
  ...
  <div class="row">
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <p class="help-block">{LANG.download.friendly_link_note}</p>
      </div>
    </div>
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <table class="table table-bordered table-hover table-striped table_row">
          ...
          <tbody>
            ...
            <tr id="row_{row.item_id}">
              ...
              <td class="cot">
              	<div><strong>{LANG.download.download_group}:</strong> {row.group_name}</div>
              	...
              	<div><label for="is_focus1_{row.item_id}"><strong>Cuối trang chủ:</strong></label> <input type="checkbox" value="1" id="is_focus1_{row.item_id}" name="is_focus1[{row.item_id}]" {row.is_focus1_checked} onchange="do_check ('{row.item_id}')" /></div>
              	<div><label for="is_focus2_{row.item_id}"><strong>Slide trang chủ:</strong></label> <input type="checkbox" value="1" id="is_focus2_{row.item_id}" name="is_focus2[{row.item_id}]" {row.is_focus2_checked} onchange="do_check ('{row.item_id}')" /></div>
              </td>

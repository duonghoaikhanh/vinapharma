...
<html xmlns="https://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript" src="<?php echo $ttH->dir_mod?>js/include_manage.js"></script>
		</head>
		<body>
...
<div class="uploader">
	...
	<div class="tabbable upload-tabbable"> <!-- Only required for left/right tabs -->
				<?php } ?>
		<form action="<?php echo $this->link_act?>&sub=manage_library" method="post" enctype="multipart/form-data" id="myAwesomeDropzone" class="dropzone">
...
<!----- header div end ------->
		...
		<div class="row-fluid">
	<?php	
	$link=$this->link_act."&sub=manage_library&".$get_params;
	?>
	<ul class="breadcrumb">	
	...
	<li class="pull-right"><a id="refresh" class="btn-small" href="<?php echo $this->link_act."&sub=manage_library&".$get_params.$subdir."&".uniqid() ?>"><i class="icon-refresh"></i></a></li>
		...
		foreach ($files as $file_array) {
			...
			<li data-name="<?php echo $file ?>" <?php if($file=='..') echo 'class="back"'; else echo 'class="dir"'; ?>>
				<figure data-name="<?php echo $file ?>" class="<?php if($file=="..") echo "back-"; ?>directory" data-type="<?php if($file!=".."){ echo "dir"; } ?>">
						<a class="folder-link" href="<?php echo $this->link_act."&sub=manage_library&".$get_params.rawurlencode($src)."&".uniqid() ?>">
			...
			<?php }else{ ?>
						...
						<div class="box">
					<h4 class="<?php if($ellipsis_title_after_first_row){ echo "ellipsis"; } ?>"><a class="folder-link" data-file="<?php echo $file ?>" href="<?php echo $this->link_act."&sub=manage_library&".$get_params.rawurlencode($src)."&".uniqid() ?>"><?php echo $file; ?></a></h4>
						</div>
			...
			$file=$file_array['file'];
				...
				if($img_width<45 && $img_height<38){
						...
						//$mini_src=$thumbs_base_url.$subfolder.$subdir.$file;

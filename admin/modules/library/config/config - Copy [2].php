...
$base_url=$ttH->conf["rooturl"];  // DON'T TOUCH (base url (only domain) of site (without final /)).
...
$current_path = $ttH->conf['rootpath'].'uploads/'; // relative path from filemanager folder to upload folder (with final /)
$current_thumbs_size = $ttH->conf['rootpath'].'thumbs_size/';
$current_src = $ttH->conf['rooturl'].'uploads/';
if(isset($ttH->conf["folder_up"])){

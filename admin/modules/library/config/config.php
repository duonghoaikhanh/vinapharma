...
$base_url=$ttH->conf["rooturl_web"];  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = 'uploads/'; // path from base_url to base of upload folder (with start and final /)
if(isset($ttH->conf["folder_up"])){
	$upload_dir .= $ttH->conf["folder_up"].'/';
}
$current_path = $ttH->conf['rootpath_web'].'uploads/'; // relative path from filemanager folder to upload folder (with final /)
$current_thumbs_size = $ttH->conf['rootpath_web'].'thumbs_size/';
$current_src = $ttH->conf['rooturl_web'].'uploads/';
if(isset($ttH->conf["folder_up"])){
	$current_path .= $ttH->conf["folder_up"].'/';
	$current_thumbs_size .= $ttH->conf["folder_up"].'/';
	$current_src .= $ttH->conf["folder_up"].'/';
}
//thumbs folder can't put inside upload folder
//$thumbs_base_path = '../thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
$thumbs_base_path = $ttH->conf['rootpath_web'].'thumbs/';
$thumbs_base_url = $ttH->conf['rooturl_web'].'thumbs';
if(isset($ttH->conf["folder_up"])){
	$thumbs_base_path .= $ttH->conf["folder_up"].'/';
	$thumbs_base_url .= '/'.$ttH->conf["folder_up"].'/';
}
